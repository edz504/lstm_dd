...
void EuclideanLossDrivingLayer<Dtype>::Reshape(
...
template <typename Dtype>
void EuclideanLossDrivingLayer<Dtype>::Forward_cpu(const vector<Blob<Dtype>*>& bottom,
    const vector<Blob<Dtype>*>& top) {

  int count = bottom[0]->count();
  /////////////////////////////////// NOTICE
  int num = bottom[0]->num()*bottom[0]->channels(); /////////////// batch size for lstm
  //int num = bottom[0]->num(); ////////////////////////////// batch size for 1F driving
  /////////////////////////////////// NOTICE
...
template <typename Dtype>
void EuclideanLossDrivingLayer<Dtype>::Backward_cpu(const vector<Blob<Dtype>*>& top,
...
#ifdef CPU_ONLY
STUB_GPU(EuclideanLossDrivingLayer);
#endif

INSTANTIATE_CLASS(EuclideanLossDrivingLayer);
REGISTER_LAYER_CLASS(EuclideanLossDriving);
