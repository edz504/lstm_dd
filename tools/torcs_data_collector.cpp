...
//  Input keys 
//  Esc: exit
//  P: pause (initially paused, each pause will automatically add clip beginning marker for lstm)
//
////////////////////////////////////////////////
...
int main(int argc, char** argv) {
    ...
    leveldb::Status status = leveldb::DB::Open(options, "/D/TORCS_Training_1F", &db);
